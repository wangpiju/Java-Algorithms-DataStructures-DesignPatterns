...
import algorithms.ListIterator;

public class Test_ListIterator extends ListIterator<Object>{
	
	public Test_ListIterator() {
	...
	public void testMain() {
		...
		ListIterator  singleIterator = new ListIterator(Arrays.asList(a,b,c,d,e));
